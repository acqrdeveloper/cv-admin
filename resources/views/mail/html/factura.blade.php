            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
                    <td style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: justify;">
                        <p style="margin: 0;">
                            ...
                            {!! $msg !!}
                            @elseif($vencido==0)
                            <strong>Súmate al Éxito</strong> le recuerda que HOY vence su factura. Cancela y evita que su servicio sea suspendido.
                            @else
                            <strong>Súmate al Éxito</strong> le recuerda que tiene una factura vencida. Cancele y evite la suspensión de su servicio y/o cargos por reconexión de su servicio.
                            @endif
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: center;">
                        <p style="margin: 0;"><b>Documento:</b> {{ $documento }}</p>
