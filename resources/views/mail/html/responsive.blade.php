            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;">
                <tr>
                    <td style="padding: 20px 0; text-align: center">
                        @if(isset($message))
                            <img src="{{ $message->embed(public_path() . '/images/cv-mail.png') }}" width="200" height="50" alt="alt_text" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;"/>
                        @else
                            <img src="{{ asset('/images/cv-mail.png') }}" width="200" height="50" alt="alt_text" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;"/>
                        @endif
                    </td>
                </tr>
            </table>
                                                                    ...
                                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size: 14px;text-align: left;">
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <div><b>Correo</b>: atencionalcliente2@centrosvirtuales.com</div> 
                                                                                <div><b>Central</b>: 707-3500 <b>Anexo</b>: 301-302</div>
                                                                                <div><b>Celular</b>: 975453170 - 966019104</div> 
                                                                            </td>
                                                                        </tr>
                                                                    ...
                                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size: 14px;text-align: left;">
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <div><b>Asesor</b>: Mari Luz Rondinel</div>
