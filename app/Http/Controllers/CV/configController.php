...
class configController extends Controller {
	...
	public function getOficinaList(){
		try {
			...
			$r = $r->orderBy('o.piso_id','o.nombre')->get(['o.id','o.modelo_id','o.local_id','o.capacidad','o.nombre_o','o.estado','c.nombre as local_nombre','m.nombre as modelo_nombre', 'o.piso_id', 'o.nombre as oficina_nombre']);
